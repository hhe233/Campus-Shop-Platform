...
public class ImageUtil {
	...
	public static String generateThumbnail(ImageHolder thumbnail, String targetAddr) {
		...
		logger.debug("current relatvieAddr is:" + relativeAddr);
	...
	/**
	 * 创建目标路径所涉及到的目录，即/home/work/store.xxx.jpg, 那么home, work, store
	 * 这三个文件夹都得自动创建
	 * @param targetAddr
	 */
	...
	public static void main(String[] args) throws IOException {
		...
		.toFile("/Users/hetingrui/store/xiaohuangrennew.jpg");
	}
